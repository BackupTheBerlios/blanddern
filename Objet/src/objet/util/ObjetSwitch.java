 ...
 * </copyright>
 *
 * $Id: ObjetSwitch.java,v 1.1 2008/06/03 13:29:27 scheerj Exp $
 */
package objet.util;
...
public class ObjetSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ObjetPackage.MODELE_CLASSES: {
				ModeleClasses modeleClasses = (ModeleClasses)theEObject;
				T result = caseModeleClasses(modeleClasses);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjetPackage.CLASSE: {
				Classe classe = (Classe)theEObject;
				T result = caseClasse(classe);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjetPackage.PROPRIETE: {
				Propriete propriete = (Propriete)theEObject;
				T result = casePropriete(propriete);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjetPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = casePropriete(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ObjetPackage.ATTRIBUT: {
				Attribut attribut = (Attribut)theEObject;
				T result = caseAttribut(attribut);
				if (result == null) result = casePropriete(attribut);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Modele Classes</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Modele Classes</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseModeleClasses(ModeleClasses object) {
		return null;
	}
